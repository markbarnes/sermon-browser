...
function sb_options() {
    ...
    <div class="wrap">
        ...
        <form method="post">
            ...
            <p class="submit"><input type="submit" name="resetdefault"
                                     value="<?php _e( 'Reset to defaults', 'sermon-browser' ) ?>"/>&nbsp;<input
                        type="submit" name="save" value="<?php _e( 'Save', 'sermon-browser' ) ?> &raquo;"/></p>
    </div>
    </form>
	<?php
}
